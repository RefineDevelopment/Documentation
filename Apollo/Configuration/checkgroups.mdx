...
:::note
Global Placeholders do not work here.
:::

- %player% - the name of a player
- %banid% - the ban id, not compatible with PX_BAN/PX_COMP
- %info% - debug info from the flag
- %check% - the check name
- %group% - the check group
- %dev% - is the check experimental?
- %vl% - the check's vl
- %group_vl% - the check group's vl
- %ping% - the player's ping
- %type% - the id of a check