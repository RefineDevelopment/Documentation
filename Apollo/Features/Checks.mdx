...
Checks look for specific cheats that a player has, eg: Killaura, Flight, etc.

The same cheat can have multiple different checks (Killaura A, Killaura B) and have individual descriptions.
