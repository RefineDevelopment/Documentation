...
Realtime Network Sync requires a redis database to be setup, [KeyDB](https://docs.keydb.dev/docs/ppa-deb) is a higher performance database that can be used with Apollo Realtime Network Sync.
