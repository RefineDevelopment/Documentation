...
<Tabs queryString="type">
    <TabItem value="spigot" label="Paper" default>
        ...
        4. Enter your [MongoDB](https://www.mongodb.com/) details in Bolt's database.yml, reboot, and Bolt should be ready.<br/>
    </TabItem>
</Tabs>
...
<details>
<summary>Does Bolt support Phoenix Nametags?</summary>
