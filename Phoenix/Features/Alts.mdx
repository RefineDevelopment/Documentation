...
The alts system allows admins to view players that share the same IP address. This helps detect punishment evasion. You can view alts through a menu or a command.
