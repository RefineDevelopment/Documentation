...
| `core.admin`                              | Permissions to Bypass TAB completion and admin alerts server statuses and admin chat and admin profile menu                                                                       |
| `core.staff`                              | Access to viewing staff chat and reports and helpop and other stuff                     |
| `core.media`                              | Be marked as media ex. (/medialist)                                                     |
...
| `core.tags.[tagname] or .*`               | Make a rank grant automatically give tag grants too                                     |
