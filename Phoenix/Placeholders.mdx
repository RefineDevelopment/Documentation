...
`%phonix_player_rank_color%`                     | The player's highest rank's color.                     | `&b`
`%phonix_player_rank_prefix%`                    | The player's highest rank's prefix.                    | `&b[MVP]`
`%phonix_player_rank_suffix%`                    | The player's highest rank's suffix.                    | `Suffix`
`%phonix_player_rank_playerlist_prefix%`         | The player's highest rank's tab prefix.                | `&b`
...
`%phonix_player_general_rank_color%`             | The player's highest non-disguise rank's color.        | `&4`
`%phonix_player_general_rank_prefix%`            | The player's highest rank's prefix.                    | `&4[OWNER]`
`%phonix_player_general_rank_suffix%`            | The player's highest rank's suffix.                    | `Suffix`
`%phonix_player_general_rank_playerlist_prefix%` | The player's highest rank's tab prefix.                | `&4`
